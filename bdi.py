...
class bdi_p2020(bdi):
    def __init__(self, ip_address, dut_ip_address, rsakey, dut_serial_port,
        ...
        self.registers = ['bbear', 'bbtar',  # 'altcar', 'altcbar', 'autorstsr',
                          ...
                          # 'cap_ext_addr', 'ccsrbar', 'clkocr',
                          'cs0_bnds',  # 'cs0_config', 'cs0_config_2',
                          # 'cs1_bnds',
                          'cs1_config',  # 'cs1_config_2', 'cs2_bnds',
                          # 'cs2_config', 'cs2_config_2',
                          'cs3_bnds',  # 'cs3_config',
                          'cs3_config_2', 'csrr0', 'csrr1', 'ctr', 'dac1',
                          'dac2',  # 'dbcr0',
                          'dbcr1', 'dbcr2',  # 'dbsr',
                          ...
                          'err_sbe',  # 'esr',
                          'fbar', 'fbcr', 'fcr', 'fir',  # 'fmr',
                          'fpar',  # 'gpporcr', 'hid0', 'hid1',
                          'iac1', 'iac2',  # 'ivor0', 'ivor1', 'ivor2', 'ivor3',
                          'ivor4', 'ivor5', 'ivor6',  # 'ivor7', 'ivor8',
                          'ivor9', 'ivor10',  # 'ivor11', 'ivor12', 'ivor13',
                          # 'ivor14', 'ivor15',
                          'ivor32',  # 'ivor33',
                          'ivor34',  # 'ivor35', 'ivpr', 'l1cfg0', 'l1cfg1',
                          # 'l1csr0', 'l1csr1', 'l2captdatahi', 'l2captdatalo',
                          # 'l2captecc',
                          'l2cewar0',  # 'l2cewar1',
                          'l2cewar2',  # 'l2cewar3', 'l2cewarea0',
                          'l2cewarea1',  # 'l2cewarea2', 'l2cewarea3',
                          'l2cewcr0', 'l2cewcr1', 'l2cewcr2', 'l2cewcr3',
                          ...
                          'lurt', 'mamr', 'mar',  # 'mas0', 'mas1',
                          'mas2', 'mas3',  # 'mas4', 'mas6', 'mas7',
                          'mbmr', 'mcmr',  # 'mcpsumr', 'mcsr',
                          'mcsrr0', 'mcsrr1', 'mdr',  # 'mm_pvr', 'mm_svr',
                          # 'mmucfg', 'mmucsr0',
                          'mrtpr', 'or0', 'or1', 'or2', 'or3', 'or4', 'or5',
                          'or6', 'or7',  # 'pid', 'pid0', 'pid1',
                          'pid2', 'pir',  # 'porbmsr', 'pordbgmsr', 'pordevsr',
