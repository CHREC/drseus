...
class bdi_p2020(bdi):
    def __init__(self, ip_address, dut_ip_address, rsakey, dut_serial_port,
        ...
        self.registers = ['altcar', 'altcbar', 'autorstsr', 'bbear', 'bbtar',
                          ...
                          'cs3_config', 'cs3_config_2', 'csrr0', 'csrr1', 'ctr',
                          'dac1', 'dac2', 'dbcr0', 'dbcr1', 'dbcr2', 'dbsr',
                          ...
                          'ddr_wrlvl_cntl', 'ddr_zq_cntl', 'ddrcdr_1',
                          'ddrcdr_2', 'ddrclkdr', 'ddrdsr_1', 'ddrdsr_2',
                          'dear', 'dec', 'decar', 'devdisr', 'ecc_err_inject',
                          'ecmcr', 'ectrstcr', 'eeatr', 'eebacr', 'eebpcr',
                          'eedr', 'eeer', 'eehadr', 'eeladr', 'egpr0', 'egpr1',
                          'egpr2', 'egpr3', 'egpr4', 'egpr5', 'egpr6', 'egpr7',
                          'egpr8', 'egpr9', 'egpr10', 'egpr11', 'egpr12',
                          'egpr13', 'egpr14', 'egpr15', 'egpr16', 'egpr17',
                          'egpr18', 'egpr19', 'egpr20', 'egpr21', 'egpr22',
                          'egpr23', 'egpr24', 'egpr25', 'egpr26', 'egpr27',
                          'egpr28', 'egpr29', 'egpr30', 'egpr31', 'eipbrr1',
                          'eipbrr2', 'err_detect', 'err_disable',
                          'err_inject_hi', 'err_inject_lo', 'err_int_en',
                          'err_sbe', 'esr', 'fbar', 'fbcr', 'fcr', 'fir', 'fmr',
                          'fpar', 'gpporcr', 'hid0', 'hid1', 'iac1', 'iac2',
                          'ivor0', 'ivor1', 'ivor2', 'ivor3', 'ivor4', 'ivor5',
                          'ivor6', 'ivor7', 'ivor8', 'ivor9', 'ivor10',
                          'ivor11', 'ivor12', 'ivor13', 'ivor14', 'ivor15',
                          'ivor32', 'ivor33', 'ivor34', 'ivor35', 'ivpr',
                          'l1cfg0', 'l1cfg1', 'l1csr0', 'l1csr1',
                          'l2captdatahi', 'l2captdatalo', 'l2captecc',
                          'l2cewar0', 'l2cewar1', 'l2cewar2', 'l2cewar3',
                          'l2cewarea0', 'l2cewarea1', 'l2cewarea2',
                          'l2cewarea3', 'l2cewcr0', 'l2cewcr1', 'l2cewcr2',
                          'l2cewcr3', 'l2ctl', 'l2erraddrh', 'l2erraddrl',
                          'l2errattr', 'l2errctl', 'l2errdet', 'l2errdis',
                          ...
                          'lawar11', 'lawbar0', 'lawbar1', 'lawbar2', 'lawbar3',
                          'lawbar4', 'lawbar5', 'lawbar6', 'lawbar7', 'lawbar8',
                          'lawbar9', 'lawbar10', 'lawbar11', 'lbcr',
                          'lbcvselcr', 'lcrr', 'lr', 'lsdmr', 'lsor', 'lsrt',
                          'ltear', 'lteatr', 'ltedr', 'lteir', 'ltesr', 'lurt',
                          'mamr', 'mar', 'mas0', 'mas1', 'mas2', 'mas3', 'mas4',
                          'mas6', 'mas7', 'mbmr', 'mcmr', 'mcpsumr', 'mcsr',
                          'mcsrr0', 'mcsrr1', 'mdr', 'mm_pvr', 'mm_svr',
                          'mmucfg', 'mmucsr0', 'mrtpr', 'or0', 'or1', 'or2',
                          'or3', 'or4', 'or5', 'or6', 'or7', 'pid', 'pid0',
                          'pid1', 'pid2', 'pir', 'porbmsr', 'pordbgmsr',
                          'pordevsr', 'porimpscr', 'porpllsr', 'powmgtcsr',
                          'pvr', 'rstcr', 'rstrscr', 'sp', 'spefscr', 'sprg0',
                          'sprg1', 'sprg2', 'sprg3', 'sprg4', 'sprg5', 'sprg6',
                          'sprg7', 'srdscr0', 'srdscr1', 'srdscr2', 'srr0',
                          'srr1', 'svr', 'tbl', 'tbu', 'tcr', 'timing_cfg_0',
                          'timing_cfg_1', 'timing_cfg_2', 'timing_cfg_3',
                          'timing_cfg_4', 'timing_cfg_5', 'tlb0cfg', 'tlb1cfg',
                          'tsr', 'usprg0', 'xer']
