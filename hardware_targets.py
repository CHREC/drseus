devices = {
    ...
    'a9_bdi': {
        ...
        'GPR': ['r0', 'r1', 'r2', 'r3', 'r4', 'r5', 'r6', 'r7', 'r8', 'r9',
                'r10', 'r11', 'r12', 'r13', 'r14'],
        'CPU': ['pc', 'cpsr',  # 'spsr', 'mainid', 'cachetype', 'tcmstatus',
                # 'tlbtype', 'mputype', 'multipid', 'procfeature0',
                # 'procfeature1', 'dbgfeature0', auxfeature0', 'memfeature0',
                # 'memfeature1', 'memfeature2','memfeature3', 'instrattr0',
                # 'instrattr1', 'instrattr2', 'instrattr3', 'instrattr4',
    ...
    'p2020': {
        ...
        'GPR': ['egpr0', 'egpr1', 'egpr2', 'egpr3', 'egpr4', 'egpr5', 'egpr6',
                'egpr7', 'egpr8', 'egpr9', 'egpr10', 'egpr11', 'egpr12',
                'egpr13', 'egpr14', 'egpr15', 'egpr16', 'egpr17', 'egpr18',
                'egpr19', 'egpr20', 'egpr21', 'egpr22', 'egpr23', 'egpr24',
                'egpr25', 'egpr26', 'egpr27', 'egpr28', 'egpr29', 'egpr30',
                'egpr31'],
        'CPU': ['bbear', 'bbtar',  # 'altcar', 'altcbar', 'autorstsr',
                # 'bptr', 'br0', 'br1', 'br2',
                'br3',  # 'br4',
                'br5',  # 'br6',
                'br7',  # 'bucsr',
                ...
                # 'eeer', 'eehadr', 'eeladr', 'eipbrr1', 'eipbrr2',
                # 'err_detect', 'err_disable',
